...
def procInputVarDecs (VarDict, rawVarDecStr, WriteToTable, WriteToField, QryOnUniqueField, DataType):
...
# rawVarDecStr is the string holding the csv variable declarations. Each variable declaration is separated by a comma
#   expected format: var_type DELIMITER val, var_type DELIMITER val, ... , var_type DELIMITER val
